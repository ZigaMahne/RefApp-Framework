...
/* Non-Secure Code */
#define NS_ROM_ALIAS      (0x01000000 + 0x00100000) /* SRAM_BASE_NS */
#define TOTAL_NS_ROM_SIZE (0x00100000)              /* 1 MB */

/* Non-Secure Data */
#define NS_RAM_ALIAS      (0x21000000 + 0x00200000) /* ISRAM0_BASE_NS */
